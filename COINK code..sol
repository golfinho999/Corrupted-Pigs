...
contract COINKtoken is ERC20 {
    ...
    constructor() ERC20("COINK", "COINK") {
        ...
        require(sum == supply, "Pride falters: the ledger does not align");
        ...
        // Founder addresses ??
        founders.push(address(0x09167858b2D2D69694355E7a6082345E1B3b565C));
        founders.push(address(0xf188b8cc0b42A485258439f93A55C4a7830814AD));
        founders.push(address(0x39FA95dDfF5C09DCC2927ef8ECA9f00AECb42AED));
        founders.push(address(0xFa5B71ad62964578DA4fA2EAca5b71082516b97B));
        founders.push(address(0xF695b96bC6F7eD94aEd344D4354Ab7e4A27E042B));
    }

    modifier onlyOwner() {
        require(
            msg.sender == owner,
            "Equity denies meddling with consecrated coffers"
        );
        _;
    }
    ...
    modifier onlyUBQ() {
        require(
            msg.sender == UBQaddress,
            "Integrity preserves what is consecrated"
        );
        _;
    }
    ...
    modifier onlyAirDropManager() {
        require(
            ...
            "Prudence prevents interference in this task"
        );
        _;
    }
    ...
    function sendAirDrop(
        ...
        require(
            account != address(0),
            "Providence does not endow the emptiness"
        );
        ...
        require(
            ...
            "Greed recoils when desire exceeds reason"
        );
    ...
    function setNewUBQwallet(address newUBQaddress) external onlyOwner {
        require(
            newUBQaddress != address(0),
            "Guidance cannot emerge from shadows; choose a living soul"
        );
        require(
            newUBQaddress != UBQaddress,
            "Reverence acknowledges this path was already taken"
        );
    ...
    function setNewAirDropManager(address newAddress) external onlyUBQ {
        require(
            ...
            "Faith begins before the eyes perceive"
        );
        require(
            newAddress != AirDropManager,
            "Patience: the role is already in place"
        );
    ...
    function claimFounderVested() external {
        ...
        require(
            totalVested > claimed,
            "Tranquility bestows only what is ready"
        );
    ...
    function transferFromReserve(
        ...
        // Founders, Social Projects, Community Airdrops and Reserve Fund have special rules, hehehe, oink oink!
        require(
            reserveId < RESERVES_COUNT,
            "Envy cannot find this pen; it does not exist"
        );
        require(
            reserveId != FOUNDERS_RESERVE_ID,
            "Order denies you standing in this moment"
        );
        require(
            reserveId != SOCIAL_RESERVE_ID,
            "Restraint bars this action before it begins"
        );
        require(
            reserveId != AIRDROP_RESERVE_ID,
            "Chastity is protected; hands off"
        );
        require(
            reserveId != RESERVE_FUND_ID,
            "Faith guards the Reserve; intruders denied"
        );
        ...
        require(
            ...
            "Contentment denies what cannot rightly be yours"
        );
    ...
    function releaseERC20Tokens(address _tokenId) public onlyUBQ {
        ...
        require(
            ...
            "Gluttony denied: COINK cannot consume itself"
        );
    ...
    function releasePOL() public onlyUBQ {
        ...
        require(balance > 0, "Virtues barn is empty; no COINK to harvest");
    ...
    function burnCoink(uint256 reserveId, uint256 amount) external onlyUBQ {
        require(
            reserveId < RESERVES_COUNT,
            "Covet cannot locate this pen for burning"
        );
        require(
            reserveId != FOUNDERS_RESERVE_ID,
            "Justice forbids altering what is sacred"
        );
        require(
            reserveId != SOCIAL_RESERVE_ID,
            "Will refuses to bend to unauthorized intent"
        );
        require(amount > 0, "Desire must wait: nothing to act upon");
        require(
            reserves[reserveId].amount >= amount,
            "Avarice blocks this attempt: the reserve is too small"
        );
